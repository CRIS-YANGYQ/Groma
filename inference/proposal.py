...
prompt_template_1 = """[grounding] There are categories you need to describe with positions, including <p>{}</p> and no other. You are not allowed to use any other categories. Give me a short description of the image and include the coordinates [[x0,y0,x1,y1]] for each instance of categries."""
